  ...
  projects: [
    {
      ...
      year: "2026",
      description:
        "Designed and deployed a serverless Express.js REST API on AWS Lambda using the Serverless Framework and API Gateway, eliminating server management overhead. Connected to a Neon serverless PostgreSQL database for scalable, low-maintenance data persistence.",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuC6sFRTeBqWVoi37wZhNOYWZQjxA0sCzy9QzNac7aLecdlfz2rpzSBUIYs63kpokktwksPlvMnOBMTTcoWmjE9yByG-SEYSThubqR0lShz1c2hEf3j5nejxZF9L4eZ7ZhgwXDsGQRun6IFLZQEoajcr1rUIwobjbx6xNknamGcwz28ppc8i4Eh4lvfg6Ez6ov-Fdwwp_qhxHTl1rFYTKktQoR5si1rUy0LY9Bk23t68xOVu5hbX10I11Q",
      tags: [
        "AWS Lambda",
        "Express.js",
        "Serverless Framework",
    ...
    },
    {
      ...
      year: "2026",
      description:
        "Retrieval-Augmented Generation (RAG) Pipeline built with Python and FastAPI. Features a Dockerized PostgreSQL vector store for semantic search, document ingestion pipeline, and query interface for grounded LLM responses.",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuAsvj1K0LvIMN6U5ZlkQzwl7Hg0KQLk32YQz-27nN4t06ILHaVVn1iN6N334yX7SK1WweIP0NODHovBVK2bSVV5Eb7mONO5y3OBHbmCCar2w0AEl_Ae0KcW34-cvzVc2Ysuft7NcxQsYQ5SPAXe6kPVFrt7z7Ys4PlvrDmlIiNJNkT8kw5qxPhGkl6hBYRV4dK4sbNqJTUqpzePm0VRhA80gMZ6pYJLVi__Sv5Xt-oW1ifBIFPmFoAlrw",
    ...
    },
    {
      ...
      year: "2026",
      description:
        "Full-stack job-hunt tracking web app built with MERN stack to manage applications through the hiring pipeline. Features status tracking, priority settings, custom labels, and networking-contact records linked to companies.",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCmiQS1NqrCMzRKMEG6v96FXUinbHFZd2MUi7KokFYgbpSNoGi2qLHlcseR5EnyjwIZ-HsPAj5cjNrlidb4pSapXF8UXeP5p_Pjj6vD5Tj7Z9nJ6G4I0vsQTS8SpeoVkwxboBJ7EOOKm-fUh9MelJdXnOzd5UbmM1L3gdx6E1BdDuJ79_FJDFgemXh01KgUEQ50fbAkSLesm5Ysjb5qMgicX3saDTY4oD7LM4YOJHfWv3NOAzCTglIpfg",
    ...
    },
    {
      ...
      year: "2024",
      description:
        "AI-powered financial tracking and budgeting web application utilizing the Gemini API for smart, personalized spending breakdowns. Built with MERN stack for robust multi-user transactional records.",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuADdr6SofZ9zZsLZkMG654XTKpcYYTV2hU2IvSpI5SSQbl9eNNmOnCFzk9MumqrmyHgUkTG9vioOUKGxVDe2tIyPRB4pUaR8LGOHPf-u4Y47dYMakxBwOee96RItr4RgBtMNO2EVwyLKiOXzAyStHYGdZZ0dpW9yxQ1yu2n2ez1nr7jBY7MzrStlLsZcpnoX8eq4Ng6SkwwrbwQd9nAbMeGoe4lkmFnr5JZDL2jM7fxTZRVD3-wgzgYk2KR3N3HUsDFOHQnONMleszE",
    ...
    },
    {
      ...
      year: "2024",
      description:
        "Intelligent language learning web app powered by Gemini API. Architected user authentication and AI-powered chatbot interactions using MERN stack with a responsive, optimized UI.",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuApHrJHDi5TN7TlmINofvHcctMU1Y_46zOmOZK-PZNxIuw3kvnYFN25-jDJopxTrQYK4-on4IVAMaJD558kIKuxfPa0TtF8Io1q9LAQ70wH-jTOvkxtTS7cHRX7hWVd6u_6BzSs88HD4xbFbLhYiMjjRHJliY1TGGHKtXcSYenSXtPq9LXAVBVjkHiwoQe1lCf0Gd1B6_t0NXH8a-DfHuC8-vJElrNgQi2KMI8N9SqgiRC6oc9O31GMYNUBA2nl6cXKnlED0xYhZhKd",
    ...
    },
    {
      ...
      year: "2023",
      description:
        "Task management tool built with MERN stack featuring user authentication, task editing, deletion, and secure access controls. Prioritizes security and usability with a minimalist, responsive design.",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDMUxRrSPV3F7__qethW5pF_Xf6-2EdZN9tvfmle-SnJ9A3Fe10T9soo-7gARmBolT60YJov77ggO64vHauBWpRDb1_EjBrh-0E-OdzNqJ-dnCMzJuUUOAxjWps1DzMltUuQRPd87aoR89TSVpavLnut2ImBUX_POWs9KVZ1zQiOdOx9xbSgpeawh5degt_zeAqoPJUxhLbIHB_DDNf7_laNdtau6MuRFmrmWEr822QEPp-8BYySLowd0l8RO4aR99jocjXwBWfKBCs",
